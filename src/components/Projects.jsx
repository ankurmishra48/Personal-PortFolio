...
const projectData = [
...

 {
  ...
  image: "/food.png",
  link: "https://github.com/ankurmishra48/FOOD-WASTE-CONNECT"
},
{
  id: 2,
  title: "RentNService",
  ...
  image: "/rent.png",
  link: "https://github.com/ankurmishra48/RentNService"
},
...

  {
    ...
    image:
      "https://th.bing.com/th/id/OIP.jAj2_Dq0DMbKPd-frCZzZAHaFm?w=768&h=581&rs=1&pid=ImgDetMain",
...

  {
    ...
    image:
      "https://1.bp.blogspot.com/-32LSjkNQD7Q/X4lDX7XyZsI/AAAAAAAAKAM/vmtadshhnsU3KxDnD55qC3E9WQGLgv59ACLcBGAsYHQ/s1366/Screenshot%2B%2528179%2529.png",
  ...
  return (
    ...
    >
      ...
      <p className="text-center text-gray-700 max-w-2xl mx-auto text-lg">
        Explore my recent projects covering Full Stack Development,
        Microservices, Frontend Development, and DSA.
      </p>
